...
abstract class ClipperBase32 protected constructor() {
     ...
     */
    inner class Vertex(pt: Point32, flags: Int, prev: Vertex?) {
        var pt = Point32()
    ...
    protected fun reset() {
        if (!isSortedMinimaList) {
            minimaList.sortWith(Comparator<LocalMinima32> { locMin1: LocalMinima32, locMin2: LocalMinima32 ->
    ...
    protected fun addPathsToVertexList(paths: Paths32, polytype: PathType, isOpen: Boolean) {
        for (path in paths) {
            var v0: Vertex? = null
    ...
    companion object {
        ...
        private fun topX(ae: Active, currentY: Int): Int {
            ...
            return if (currentY == ae.bot!!.y) {
                ae.bot!!.x
            } else ae.bot!!.x + (ae.dx * (currentY - ae.bot!!.y)).roundToInt()
        }
