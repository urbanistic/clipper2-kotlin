...
import clipper2.core.InternalClipper.pointInPolygon
 ...
 */
@JsExport
open class RectClip(rect: Rect64) {
    protected class OutPt2(var pt: Point64) {
    ...
    protected val rect: Rect64
    protected val mp: Point64
    protected val rectPath: Path64
    protected var pathBounds: Rect64? = null
    ...
    protected fun add(pt: Point64, startingNewPath: Boolean = false): OutPt2? {
    ...
    protected fun getNextLocation(path: Path64, loc: RefObject<Location>, i: RefObject<Int>, highI: Int) {
        when (loc.argValue) {
            Location.LEFT -> {
    ...
    fun execute(paths: Paths64, convexOnly: Boolean): Paths64 {
        val result = Paths64()
        if (rect.isEmpty()) {
            return result
        }
    ...
    companion object {
        private fun path1ContainsPath2(path1: Path64, path2: Path64): Boolean {
        ...
        private fun getEdgesForPt(pt: Point64, rec: Rect64): Int {
        ...
        private fun isHeadingClockwise(pt1: Point64, pt2: Point64, edgeIdx: Int): Boolean {
            return when (edgeIdx) {
                0 -> pt2.y < pt1.y
                1 -> pt2.x > pt1.x
                2 -> pt2.y > pt1.y
        ...
        private fun hasHorzOverlap(left1: Point64, right1: Point64, left2: Point64, right2: Point64): Boolean {
            return left1.x < right2.x && right1.x > left2.x
        }

        private fun hasVertOverlap(top1: Point64, bottom1: Point64, top2: Point64, bottom2: Point64): Boolean {
        ...
        @JvmStatic
        protected fun getLocation(rec: Rect64, pt: Point64, loc: OutObject<Location>): Boolean {
